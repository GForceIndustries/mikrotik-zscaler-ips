...
add dont-require-permissions=yes name=zscaler-ips owner=admin policy=ftp,read,write,test source=":log info \"Download Zscaler IP list\";\r\
    \n/tool fetch url=\"https://raw.githubusercontent.com/GForceIndustries/mikrotik-zscaler-ips/refs/heads/main/zscaler-ips-recommended-v4.rsc\" mode=https dst-path=zscaler-ips-recommended-v4.rsc;\r\
    \n/tool fetch url=\"https://raw.githubusercontent.com/GForceIndustries/mikrotik-zscaler-ips/refs/heads/main/zscaler-ips-recommended-v6.rsc\" mode=https dst-path=zscaler-ips-recommended-v6.rsc;\r\
    \n\r\
    ...
    \n/import file-name=zscaler-ips-recommended-v4.rsc;\r\
